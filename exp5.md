...
The resulting scatter plot shows that our derived bounds are accurate around small thresholds, and note that the bounds are sometimes exceeded for the opacity and color parameters due to the quadratic approximation used in the derivation.
