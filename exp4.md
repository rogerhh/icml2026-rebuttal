...
Due to the substantially increased number of Gaussian splats, ADAM with densification is able to outperform our method. (Except for the `playroom` scene, where ADAM with densification outperforms our method eventually with more iterations.)
